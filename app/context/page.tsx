...
const CATEGORIES = [
  ...
  { value: 'organic_social_strategy', label: 'Organic Social Strategy' },
  { value: 'business_strategy', label: 'Business Strategy' },
  { value: 'brand_details', label: 'Brand Details' },
...
const getCategoryColor = (category: string) => {
  const colors: Record<string, string> = {
    ...
    'organic_social_strategy': '#14b8a6',
    'business_strategy': '#0ea5e9',
    'brand_details': '#d946ef',
